...
def canny_edge_detection(image, low_threshold, high_threshold, gaussian_kernel_size=5, sobel_kernel_size=3):
    ...
    duration = time.perf_counter() - start
    print(f"--- Hysteresis completed in: {duration:.4f} seconds")

    total_duration = time.perf_counter() - total_start
    print(f"\n[TOTAL COST] Algorithm finished in {total_duration:.4f} seconds")
    return edge_map
...
if __name__ == '__main__':
    ...
    high_threshold = 200 # High_threshold value for hysteresis
